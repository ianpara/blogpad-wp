        ...
        <div class="container">
            ...
            <div class="list-topic row">
                <div class="single-topic col-lg-2 col-md-4 col-6">
                    <div class="inner">
                        <img class="img-fluid" src="<?php echo get_bloginfo('template_directory'); ?>/images/topics/topic-sport.jpg" alt="">
                        <a href="" class="stretched-link">
                            <h5 class="topic">Fitness</h5>
                        </a>
                    </div>
                </div>
                <div class="single-topic col-lg-2 col-md-4 col-6">
                    <div class="inner">
                        <img class="img-fluid" src="<?php echo get_bloginfo('template_directory'); ?>/images/topics/topic-gaming.jpg" alt="">
                        <a href="" class="stretched-link">
                            <h5 class="topic">Gaming</h5>
                        </a>
                    </div>
                </div>
                ...
                <div class="single-topic col-lg-2 col-md-4 col-6">
                    <div class="inner">
                        <img class="img-fluid" src="<?php echo get_bloginfo('template_directory'); ?>/images/topics/topic-photo.jpg" alt="">
                        <a href="" class="stretched-link">
                            <h5 class="topic">Photography</h5>
                        </a>
                    </div>
                </div>
                <div class="single-topic col-lg-2 col-md-4 col-6">
                    <div class="inner">
                        <img class="img-fluid" src="<?php echo get_bloginfo('template_directory'); ?>/images/topics/topic-travel.jpg" alt="">
                        <a href="" class="stretched-link">
                            <h5 class="topic">Travel</h5>
                        </a>
                    </div>
                </div>
                <div class="single-topic col-lg-2 col-md-4 col-6">
                    <div class="inner">
                        <img class="img-fluid" src="<?php echo get_bloginfo('template_directory'); ?>/images/topics/topic-tech.jpg" alt="">
                        <a href="" class="stretched-link">
                            <h5 class="topic">Tech</h5>
                        </a>
                    </div>
                </div>
                ...
                <div class="single-topic col-lg-2 col-md-4 col-6">
                    <div class="inner">
                        <img class="img-fluid" src="<?php echo get_bloginfo('template_directory'); ?>/images/topics/topic-lifestyle.jpg" alt="">
                        <a href="" class="stretched-link">
                            <h5 class="topic">Lifestyle</h5>
                        </a>
                    </div>
                </div>
            </div>
